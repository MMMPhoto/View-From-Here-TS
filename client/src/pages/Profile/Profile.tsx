        ...
        ? <ProfileCard>
            ...
            <ProfileContent>
              <Upload>
                ...
                {status ? <CardSubtitle>{status}: {image.name}</CardSubtitle> : <CardSubtitle>Requirements: Image files only, 10MB size limit, GPS data must be embedded on file. <br/><em>There is a known issue uploading photos with GPS data on iOS devices, try uploading via desktop.</em></CardSubtitle> }
                <UploadForm>
                  <SubmitButton>
                    <label>
                      <input
